package com.example.collection.sample08;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("En küçük öğrenci: " +enKucukOgrenci);
        ...
        System.out.println("Ters sırada ogrenciler:" +ogrenciler);
        //Collections.shuffle(ogrenciler);
        //System.out.println("Karıştırıldıktan sonra : " +ogrenciler);

        //binary search için elemanların sıralı olması gerekiyor
        int sonuc = Collections.binarySearch(ogrenciler, student3);
